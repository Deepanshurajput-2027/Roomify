  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <p className="subtitle">Roomify is an AI-first design environment that helps you vusualize, render, and ship architectural projects faster than ever before.</p>
        ...
        <div className="upload-shell" id="upload">
          ...
          <div className="upload-card">
            <div className="upload-head">
              ...
              <p>Supports all image formats up to 10MB</p>
            </div>
